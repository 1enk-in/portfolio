...
const projects = [
  ...
  {
    id: 4,
    title: 'E-Commerce catalouge',
    description: 'Fashion Section E-Commerce catalouge.',
  ...
  ,
  {
    id: 6,
    title: 'EXIM-Contra',
    description: 'Lut Gaya Madarchod Isme to.',
    image: '/images/auction-system.png',
    tech: ['next', 'express', 'ts', 'tailwind', 'recoil'],
    liveLink: 'https://example.com/',
  }
  ...
  {
    id: 7,
    title: 'Ai-Modal Training (dslp data vulnerability Lifecycle process',
    description: 'Dusre ke project me hath bataya.',
    image: '/images/auction-system.png',
    tech: ['next', 'express', 'ts', 'tailwind', 'recoil'],
    liveLink: 'https://example.com/',
  }
